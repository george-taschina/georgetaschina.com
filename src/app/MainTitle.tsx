    ...
    return (
      <div className="h-screen  flex justify-center items-center">
          <div className="grid md:grid-cols-2 w-screen	">
            <div className={opacity ? "opacity-100 transition-all ease-in duration-700 sm:order-1 order-2 text-center" : "opacity-0 mt-5 transition-all ease-in duration-700 sm:order-1 order-2 text-center"}>
              <div className="flex flex-col justify-center h-full px-5 sm:pl-20">
                <h1 className="text-2xl md:text-8xl font-bold text-special">Transforming Ideas Into Reality</h1>
                <h4 className="mt-2 md:mt-9 text-md md:text-2xl text-special">Building Robust & Scalable Web Solutions Tailored for YOU.</h4>
            ...
            <div className="md:block hidden sm:order-1 order-2">
              <img src="/main_title.webp" alt="hero" id="main_image" className={opacity ? "opacity-100 w-full transition-all ease-in duration-700" : "opacity-0 mt-5 w-full transition-all ease-in duration-700"} />
            </div>
