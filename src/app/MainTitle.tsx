      ...
      <div className="h-screen  flex justify-center items-center">
          <div className="grid md:grid-cols-2 w-screen	">
            ...
            <div className="md:hidden block sm:order-2 order-1">
              <Image src="/main_title_responsive.webp" alt="hero" priority id="main_image" width={900} height={900} className={opacity ? "opacity-100 w-full transition-all ease-in duration-700" : "opacity-0 mt-5 w-full transition-all ease-in duration-700"} />
             </div>
          </div>
      </div>
    );
